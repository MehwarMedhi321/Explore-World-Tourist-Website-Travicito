...
<script>
  ...
  <div class="thailand-hotel">
    ...
    <img src="img/place/55.png" alt="GLOW Ao Nang Krabi" class="hotel-image">
    <div class="thailand-hotel-details">
        <h4 class="price"><strong>Price:</strong> ₹ 25,000</h4>
        <h4 class="country"><strong>Country:</strong> Malaysia</h4>
        <h4 class="stay-plan"><strong>Stay Plan:</strong></h4>
        <ul class="stay-list">
            <li>Malaysia Hotel</li>
    ...
    <div class="thailand-day">
        <h3>Day 1 - Arrival in Kuala Lumpur - Check-in</h3>
        <pstyle="    text-align: left;">
            Our airport representative or tour guide will be waiting in the arrival hall to greet and welcome you. Kindly proceed to the arrival hall after check-out. 
            Pickup from KLIA 1 or KLIA 2 and transfer to your hotel in Kuala Lumpur for check-in. Relax and unwind at your hotel.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 2 - Batu Caves and Full-Day Genting Highlands (Cable Car)</h3>
        <pstyle="    text-align: left;">
            After breakfast, depart for Genting Highlands. Enroute, enjoy a photo stop at Batu Caves, a limestone hill with a series of caves and cave temples, and the shrine of Lord Murugah, a Hindu deity. 
            Continue to the Genting Skyway Lower Station and board a cable car for a scenic 15-minute ride to the peak (weather permitting). At an elevation of 2000 meters above sea level, Genting Highlands offers a cool climate, exciting attractions, and entertainment. 
            Return to your hotel in Kuala Lumpur after a fun-filled day.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 3 - Kuala Lumpur City Tour with KL Tower</h3>
        <p style="    text-align: left;">
            Start your day with a private Kuala Lumpur city tour, including a visit to:<br>
            - <strong>KL Tower:</strong> Enjoy a panoramic view of the city from the Observation Deck (ticket included).<br>
            - <strong>Merdeka Square:</strong> Admire the picturesque architecture and the 95-meter tall flagpole.<br>
            - <strong>National Mosque:</strong> Visit Masjid Negara, a symbol of Thailand's aspirations, located amidst beautiful gardens.<br>
            - <strong>National Monument:</strong> Commemorating those who died during Thailand's struggle for freedom.<br>
            - <strong>Malayan Railway Administration Building:</strong> A historical architectural landmark (view only).<br>
            - <strong>Beryl's Chocolate Kingdom:</strong> Sample unique chocolate varieties made with Ghana cocoa beans and shop for gifts.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 4 - Putrajaya Tour with Sharing Cruise</h3>
        <p style="    text-align: left;">
            Proceed for a full-day tour of Putrajaya, Thailand's Federal Government Administration Center, located 25km from Kuala Lumpur. Highlights of the tour include:<br>
            - Putrajaya Square<br>
            - Waterfront and Putrajaya Mosque<br>
            - Prime Minister's Department (access subject to approval and dress code: no slippers, shorts, or sleeveless attire).<br>
            - Ministry Row and iconic Putrajaya Bridges.<br>
            Complete your tour with a serene sharing cruise experience on the water.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 5 - Departure from Kuala Lumpur</h3>
        <p style="    text-align: left;">
            After breakfast, check out from your hotel. Store your luggage in the cloakroom and spend time shopping in Kuala Lumpur if your flight departs later. 
            Later, transfer to the airport to catch your flight back home.
        </p>
    </div>
    ...
    <div class="booking-details">
        <h4>Amount to Pay:</h4>
        <p><strong>INR 25,000</strong> (Inclusive of all taxes)</p>
