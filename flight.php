...
@media screen and (max-width: 768px) {
   ...
   <section style="background-image: url('img/blog/flight.jpg'); background-size: cover; padding: 50px;">
        <div class="container">
         <h2 class="form-title" style="color: black;">Flight Enquiry</h2>
            ...
            <form id="contactForm" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="number" class="phone" placeholder="Phone Number" required style="color: black;">
                </div>
                <div class="form-group">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $subject = "New  Form Submission from Enquriy Flight";
        $body = "You have received a new form Submission from Enquriy Flight:\n\n";
        $body .= "Name: $name\n";
        $body .= "Phone: $phone\n";
        $body .= "Email: $email\n";
