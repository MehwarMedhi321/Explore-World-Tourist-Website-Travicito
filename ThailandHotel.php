...
.stay-list li, .inclusion-list li {
  ...
  <div class="thailand-hotel">
    ...
    <img src="img/place/11.png" alt="GLOW Ao Nang Krabi" class="hotel-image">
    <div class="thailand-hotel-details">
        <h4 class="price"><strong>Price:</strong> ₹ 29,900</h4>
        <h4 class="country"><strong>Country:</strong> Thailand</h4>
        <h4 class="stay-plan"><strong>Stay Plan:</strong></h4>
        <ul class="stay-list">
            <li>2 Nights in Krabi</li>
    ...
    <div class="thailand-day">
        <h3>Day 1 - Arrival at Phuket - Transfer to Krabi</h3>
        <p style="    text-align: left;">Upon arrival at Phuket Airport, meet our local tour coordinator who will meet and greet you at the specified area and transfer you to your Krabi hotel. Check in to your hotel (Standard Check-in time: 1400 - 1500 hours) and relax. Rest of the day is free at your own leisure. In the evening, you can explore the nearby areas and relish freshly made cuisines at local seaside restaurants. Later, return to the hotel and sleep relaxed.</p>
    </div>
    <div class="thailand-day">
        <h3>Day 2 - Krabi Four Island Tour</h3>
        <p style="    text-align: left;">After breakfast, proceed for Krabi Four Island Day Trip. Explore the islands of Koh Tup, Koh Gai, Koh Poda, and Phra Nang Cave Beach via boat. Enjoy snorkeling, swimming, and a delicious picnic lunch at Koh Poda Island. Conclude the day at the breathtaking Phra Nang Cave Beach and return to your hotel.</p>
    </div>
    <div class="thailand-day">
        <h3>Day 3 - Transfer from Krabi to Phuket</h3>
        <p style="    text-align: left;">Enjoy breakfast, pack your bags, and check out from the hotel. Travel to Phuket, check in to your hotel, and relax. Spend the evening exploring the nearby areas and savoring local cuisines. End the day with a comfortable stay at your hotel.</p>
    </div>
    <div class="thailand-day">
        <h3>Day 4 - Full Day Phi Phi Island Tour</h3>
        <p style="    text-align: left;">
            <strong>07:30:</strong> Begin your day early with convenient hotel pickup in Phuket.<br>
            <strong>08:30:</strong> Transfer to Phuket Boat Lagoon Marina for light refreshments before embarking.<br>
            <strong>09:00:</strong> Visit Maya Bay, Monkey Beach, Pileh Cove, Viking Cave, and Loh Samah Bay.<br>
            <strong>12:30:</strong> Enjoy a buffet lunch at Phi Phi Don Island, followed by snorkeling at a secluded spot.<br>
            <strong>15:00:</strong> Stop at Khai Island for swimming, snorkeling, or relaxing on pristine beaches. Optional water sports are available.<br>
            <strong>17:00:</strong> Return to Phuket marina and transfer back to your hotel via minivan.
        </p>
    </div>
    <div class="thailand-day">
        <h3>Day 5 - Tiger Kingdom Phuket - Big/Medium Tiger (Adults Only)</h3>
        <p>
            Visit the Tiger Kingdom in Phuket and get a chance to pat or hug tigers raised by humans since birth. Watch the tigers play during the daytime, and enjoy a safe and unique interaction guided by expert handlers. Capture memorable photos with these majestic creatures and return to your hotel in the evening for an overnight stay.
        </p>
    </div>
    <div class="thailand-day">
        <h3>Day 6 - Departure from Phuket</h3>
        <p style="    text-align: left;">
            After breakfast, check out from your hotel. You will be picked up and transferred to the airport to catch your flight back home. Your trip ends with sweet memories.
        </p>
    </div>
    ...
    <div class="booking-details">
        <h4>Amount to Pay:</h4>
        <p><strong>INR  29,900</strong> (Inclusive of all taxes)</p>
