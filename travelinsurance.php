...
.section {
    background-image: url('img/blog/travelimage.jpg');
...
@media screen and (max-width: 768px) {
    ...
    <section style="background-image: url('img/blog/travelimage.jpg'); background-size: cover; padding: 50px;">
        <div class="container">
         <h2 class="form-title" style="color: black;">Travel Insurance Enquiry</h2>


            <!-- Contact Form -->
            <form id="contactForm" method="post" action="">
                <div class="form-group">
                    <label for="name" style="color: black;"><i class="fas fa-user"style="color: black;"></i> Name</label>
                    <input type="text" id="name" name="name" class="name" placeholder="Your Name" required style="color: black;">
                </div>
                <div class="form-group">
                    <label for="phone" style="color: black;"><i class="fas fa-phone-alt"style="color: black;"></i> Phone</label>
                    <input type="tel" id="phone" name="phone" class="phone" placeholder="Phone Number" required style="color: black;">
                </div>
                <div class="form-group">
                    <label for="email" style="color: black;"><i class="fas fa-envelope" style="color: black;"></i> Email</label>
                    <input type="email" id="email" name="email" class="email" placeholder="Email Address" required style="color: black;">
                </div>
                <div class="form-group">
                    <label for="message" style="color: black;"><i class="fas fa-comment-alt" style="color: black;"></i> Message</label>
                    <textarea id="message" name="message" class="message" placeholder="Your Message" required></textarea style="color: black;">
                </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $subject = "New  Form Submission from Flight";
        $body = "You have received a new form Submission from Flight:\n\n";
        $body .= "Name: $name\n";
        $body .= "Phone: $phone\n";
        $body .= "Email: $email\n";
        ...
        if(mail($to, $subject, $body, $headers)) {
            // After successful submission, redirect to flight.php
            header("Location: flight.php"); // Redirect to the flight page
