...
<div class="thailand-container">
    <div class="thailand-hotel-section">
        <!--<h4>Day 1-3 (3 Nights): Kuta Central Park Hotel</h4>-->
        <div class="thailand-hotel">
            <img src="img/place/22.png" alt="Kuta Central Park Hotel" class="hotel-image">
            <div class="thailand-hotel-details">
                <h4 class="price"><strong>Price Per Person:</strong> ₹ 29,999</h4>
                <h4 class="country"><strong>Country:</strong> Bali</h4>
                <h4 class="stay-plan"><strong>Stay Plan:</strong></h4>
                <ul class="stay-list">
                    <li>3 Nights in Kuta</li>
                    <li>2 Nights in Ubud </li>
                </ul>
                <h4 class="inclusions"><strong>Inclusions:</strong></h4>
                <ul class="inclusion-list">
                    <!--<li>Hotel Accommodation (4 Star)</li>-->
    ...
    <div class="thailand-daywise-itinerary">
        ...
        <div class="thailand-day">
            <h3>Day 1 - Arrival at Bali</h3>
            <p>Arrival at Ngurah Rai Airport, Denpasar. Meet our representative and transfer to your hotel in Kuta. Relax and spend the evening at leisure.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 2 - Water Sports and Uluwatu Temple</h3>
            <p>Experience thrilling water sports activities including Banana Boat Ride, Jet Ski, and Parasailing Adventure. In the evening, visit Uluwatu Temple perched on a cliff and witness the mesmerizing Kecak Dance performance.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 3 - Full Day Ubud Tour</h3>
            <p>Explore Ubud, including visits to Celuk (gold and silver center), Mas (woodcarving center), and the iconic Tegalalang Rice Terraces. Enjoy the Bali Swing and end the day with a visit to Tegunungan Waterfalls.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 4 - Transfer to Ubud and Garuda Wisnu Kencana</h3>
            <p>Transfer to your resort in Ubud. Visit the Garuda Wisnu Kencana Cultural Park, explore its limestone surroundings, and enjoy traditional Balinese dance performances.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 5 - Nusa Penida Island Day Trip</h3>
            <p>Take a shared fast boat to Nusa Penida. Visit Broken Beach, Kelingking Cliff, and pristine beaches. Enjoy a delicious local lunch and immerse yourself in the island's natural beauty.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 6 - Departure from Bali</h3>
            <p>After breakfast, check out and transfer to the airport for your return journey. End your trip with wonderful memories.</p>
        </div>
    </div>
    ...
    <div class="booking-details">
        <h4>Amount to Pay:</h4>
        <p><strong>INR 29,999</strong> (Inclusive of all taxes)</p>
