...
<script>
    ...
    <!--<h4>Day 1-2 (2 Nights): GLOW Ao Nang Krabi</h4>-->
  <div class="thailand-hotel">
      
    <img src="img/place/44.png" alt="GLOW Ao Nang Krabi" class="hotel-image">
    <div class="thailand-hotel-details">
        <h4 class="price"><strong>Price:</strong> ₹ 30,000</h4>
        <h4 class="country"><strong>Country:</strong> Vietnam</h4>
        <h4 class="stay-plan"><strong>Stay Plan:</strong></h4>
        <ul class="stay-list">
            <li>Vietnam Hotel</li>
            <!--<li>3 Nights in Phuket</li>-->
        </ul>
   ...
   <div class="thailand-daywise-itinerary">
    ...
    <div class="thailand-day">
        <h3>Day 1 - Arrival at Hanoi - Transfer to Hotel</h3>
        <p style="text-align: left;">
            On arrival at Noi Bai International Airport, our local representative will be waiting outside the customs area to welcome you and take you to your hotel (Check-in time is 3:00 pm). 
            The rest of the day is free for you to explore Hanoi Town on your own.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 2 - Full Day Ninh Binh Tour</h3>
        <p style="text-align: left;">
            <strong>07:30 - 08:00:</strong> Get picked up by our friendly guide and depart for Ninh Binh province.<br>
            <strong>09:15:</strong> Short break for 15-20 minutes to relax.<br>
            <strong>10:30:</strong> Visit Hoa Lu, the ancient capital of Vietnam (968-1010). Learn about Vietnamese history under the Dinh, Le, and Ly Dynasties.<br>
            <strong>11:45:</strong> Enjoy a buffet lunch with local foods like goat meat, fish, chicken, and vegetarian options.<br>
            <strong>13:00:</strong> Explore Tam Coc on a 1.5-hour bamboo boat ride, marveling at the stunning cave system and picturesque scenery often called "Ha Long Bay on land."<br>
            <strong>14:30:</strong> Cycle around the village for 45 minutes to discover local life.<br>
            <strong>15:30:</strong> Visit Mua Cave (Dancing Cave). Climb 500 steps to Lying Dragon Mountain for a panoramic view of Tam Coc.<br>
            <strong>16:30:</strong> Return to Hanoi by bus.<br>
            <strong>18:30:</strong> Drop-off at your hotel in Hanoi.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 3 - Half Day Hanoi City Tour - Water Puppet Show</h3>
        <p style="text-align: left;">
            <strong>08:00 - 08:30:</strong> Begin your Hanoi City Tour with pickup by a friendly guide.<br>
            - <strong>Tran Quoc Pagoda:</strong> Visit this ancient 6th-century pagoda on Golden Fish Island, West Lake.<br>
            - <strong>Ho Chi Minh Complex:</strong> Explore the preserved body of Ho Chi Minh and his former residence (dress modestly; the mausoleum is closed on Mondays and Fridays).<br>
            - <strong>One Pillar Pagoda:</strong> A unique architectural marvel dedicated to the Goddess of Mercy.<br>
            - <strong>Vietnam Ethnology Museum:</strong> Learn about the diverse cultures of Vietnam's 54 ethnic groups (closed on Mondays; visit the Women’s Museum instead).<br>
            After lunch, enjoy the renowned Thang Long Water Puppet Show. This traditional theatrical performance dates back to the Red River Delta and showcases puppets performing on water.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 4 - Fly from Hanoi to Da Nang</h3>
        <p style="text-align: left;">
            - Private transfer from your Hanoi hotel to the airport.<br>
            - Arrive at Da Nang and transfer to your hotel for check-in.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 5 - Ba Na Hills Tour</h3>
        <p style="text-align: left;">
            Leave Da Nang for a day trip to the Ba Na Hills. Highlights include:<br>
            - <strong>Linh Ung Pagoda:</strong> Admire the 220-foot statue of Bodhisattva.<br>
            - Cable car ride to the summit of Nui Chua Mountain.<br>
            - Trek to Nghinh Phong Peak for panoramic views.<br>
            - Tasty Vietnamese lunch at a local restaurant.<br>
            - Visit Fantasy Park, an indoor entertainment zone with thrilling games.<br>
            Return to your hotel in Da Nang after an adventurous day.
        </p>
    </div>

    <div class="thailand-day">
        <h3>Day 6 - Departure from Da Nang</h3>
        <p style="text-align: left;">
            After breakfast, check out from your hotel. You will be transferred to the airport to catch your flight back home.
        </p>
    </div>
    ...
    <div class="booking-details">
        <h4>Amount to Pay:</h4>
        <p><strong>INR 30,000</strong> (Inclusive of all taxes)</p>
