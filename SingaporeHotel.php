...
<script>
  ...
  <div class="thailand-container">
    <div class="thailand-hotel-section">
        <!--<h4>Day 1-4 (4 Nights): Hotel Boss</h4>-->
        <div class="thailand-hotel">
            <img src="img/place/33.png" alt="Hotel Boss" class="hotel-image">
            <div class="thailand-hotel-details">
                <h4 class="price"><strong>Price Per Person:</strong> ₹ 45,500</h4>
                <h4 class="country"><strong>Country:</strong> Singapore</h4>
    ...
    <div class="thailand-daywise-itinerary">
        ...
        <div class="thailand-day">
            <h3>Day 1 - Arrival in Thailand - Check-in</h3>
            <p>On arrival at Thailand Airport, meet our representative and get transferred to your hotel. Spend the evening at leisure, exploring the local dining and vibrant ambiance. Return to the hotel for an overnight stay.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 2 - Full Day Universal Studios Tour</h3>
            <p>Spend the day at Universal Studios in Thailand. Enjoy thrilling rides, explore themed zones, and experience a world of cinematic adventure.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 3 - Full Day Sentosa Tour</h3>
            <p>Visit Sentosa Island and enjoy a one-way cable car ride with stunning views. Conclude the day with the magical Wings of Time show, featuring spectacular water, laser, and fire effects set against the sea backdrop.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 4 - Marina Bay Sands and Gardens by the Bay</h3>
            <p>Explore the Marina Bay Sands and the Gardens by the Bay. Visit the Supertree Observatory and Cloud Forest, featuring the world’s tallest indoor waterfall and an array of exotic plants. Take in breathtaking views and capture unforgettable moments.</p>
        </div>

        <div class="thailand-day">
            <h3>Day 5 - Departure from Thailand</h3>
            <p>After breakfast, check out and leave your bags at the concierge. Spend the day shopping at popular locations. Later, collect your bags and transfer to the airport for your departure.</p>
        </div>
    </div>
    ...
    <div class="booking-details">
        <h4>Amount to Pay:</h4>
        <p><strong>INR 45,500</strong> (Inclusive of all taxes)</p>
